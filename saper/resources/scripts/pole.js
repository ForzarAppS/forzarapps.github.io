...
function NewGame() {
    ...
    DivButtton.onclick = function(){
        ...
        if (DivCount != null) {
            DivCount.innerHTML = "Количество мин: 0";
        }
                ...
                if (DivCell.getAttribute("data-flag") != "true") {
                    if (document.getElementsByClassName("buttons")[0] == null) {
                        ...
                        if ((DivCell.parentElement.id >= 1) && (DivCell.parentElement.id <= Math.floor(CountRow/2))) {
                            DivButtons.style.top = event.clientY+20+"px";
                        }
                        else {
                            DivButtons.style.top = event.clientY-30+"px";
                        }
                        if (cell > ((CountRow+2)*5-1)) {
                            DivButtons.style.left = event.clientX-90+"px";
                        }
                        else {
                            DivButtons.style.left = event.clientX+20+"px";
                        }
                    ...
                    if (document.getElementsByClassName("buttons")[0] == null) {
                        ...
                        if (cell > ((CountRow+2)*5-1)) {
                            ...
                            DivButtons.style.left = event.clientX+15+"px";
                        }
...
function SearchMine() {
    ...
    document.getElementsByClassName("count")[0].innerHTML = "Количество мин: "+count;
}