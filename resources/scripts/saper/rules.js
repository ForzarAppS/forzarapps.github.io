                ...
                if (DivCell.getAttribute("data-flag") != "true") {
                    ...
                    for (let button = 0; button < 2; button++) {
                        ...
                        switch (button) {
                            case 0: {
                                DivButton.id = "flag";
                                DivButton.style.backgroundImage = "url("+Path+"resources/images/saper/buttons/no-flag.png)";
                                DivButton.onclick = function() {
                                    /*установка флага*/
...
function ClearAllClick_ShowMine(FireMine) {
    if (!!FireMine) {
        FireMine.style.backgroundImage = "url("+Path+"resources/images/saper/mine/fire-mine.png)";
    }
    ...
    for (let cell = 0; cell < (CountCol+2)*(CountRow+2); cell++) {
        ...
        if (DivCell.getAttribute("data-mine") == "true") {
            ...
            if (DivCell.getAttribute("data-flag") == "true") {
                DivCell.style.backgroundImage = "url("+Path+"resources/images/saper/mine/flag-mine.png)";
            }
        }
    }
}
